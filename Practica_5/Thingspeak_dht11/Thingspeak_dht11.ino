...
// wifi credentials
const char *ssid = "Starlink"; // Tu SSID
const char *password = "Bisonte103"; // Tu PWD del SSID
WiFiClient client;
// OpenWeather
String apiTemperature;
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=20.6024&lon=-103.2714&appid=36b627b41d327f2d78178ad8e670467c"; //El path que usaste en el web para la tem de la API - TODO el path con http
// ThingSpeak
uint32_t channelNumber = 2484033; // Tu channel ID number de thingspeak
const char *writeAPIKey = "ICGBO28QJ71VOXL9"; // El API write de thingspeak
void setup()
{
Serial.begin(115200);
dht.begin();
...
ThingSpeak.setField(3, temperatureData.dht);
ThingSpeak.setField(4, apiTemperature);
